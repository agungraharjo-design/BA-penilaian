          ...
          {authView === 'login' ? (
            <>
              ...
              <p className="text-xs text-gray-400 mt-2 text-center">
                Dosen: masuk dengan Google menggunakan email @upnvj.ac.id
              </p>
            </>
          ) : (
            <>
              <h2 className="text-lg font-semibold text-center mb-4 font-serif">Daftar Akun Mahasiswa</h2>
              <p className="text-xs text-gray-500 text-center mb-4">Dosen: gunakan tombol <strong>Masuk dengan Google</strong> di halaman login.</p>
              <form onSubmit={async (e) => {
                e.preventDefault()
                const fd = new FormData(e.currentTarget)
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">Email</label>
                    <input name="email" type="email" required className="w-full border border-gray-300 rounded px-3 py-2 font-serif" placeholder="email@contoh.com" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-1">Password</label>
